...
from preprocessing import get_user_item_dict
#number of reviews for an item --> top 20% vs. bottom 80%



def split_groups(sentiment_data):
    user_dict, item_dict = get_user_item_dict(sentiment_data) #method from preprocessing return that returns: user dictionary {u1:[i, i, i...], u2:[i, i, i...]}, similarly, item dictionary --> we use the item dict
