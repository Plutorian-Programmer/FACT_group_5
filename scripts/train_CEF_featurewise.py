...
if __name__ == "__main__":
    ...
    torch.save(delta_i, 'models/CEFout/delta_i_500features_featurewise_FINAL.pt')
    torch.save(delta_u, 'models/CEFout/delta_u_500features_featurewise_FINAL.pt')
    torch.save(model.state_dict(), 'models/CEF_model_500features_featurewise_FINAL.model')
